...
const response = JSON.parse(await readFile(new URL('../src/mocks/demo.json', import.meta.url), 'utf8'));
...
assert.equal(ui.filterProducts(products, { ...ui.initialFilters, search: ' stable-001 ' }).length, 1);
