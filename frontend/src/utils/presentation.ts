...
export function filterProducts(products: DemoProduct[], filters: Filters): DemoProduct[] {
  ...
  return products
    ...
    .sort((a, b) => {
      ...
      if (filters.sort === 'cover')
        return a.calculation.days_of_cover - b.calculation.days_of_cover;
...
export const positionWord = (value: number): string =>
  plural(value, 'позиция', 'позиции', 'позиций');
export const supplierWord = (value: number): string =>
  plural(value, 'поставщик', 'поставщика', 'поставщиков');
